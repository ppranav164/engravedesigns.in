...
public class syncSavePayment extends AsyncTask<String,String,String>
{
    ...
    String API_URL = hosts.billingAdresSave;


    public syncSavePayment(Context cxt,String param, info info)
    {
