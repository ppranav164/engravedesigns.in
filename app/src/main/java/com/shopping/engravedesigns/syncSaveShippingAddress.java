...
public class syncSaveShippingAddress extends AsyncTask<String,String,String>
{
    ...
    String API_URL = hosts.shippingAddressSave;


    public syncSaveShippingAddress(Context cxt, String param, info info)
    {
