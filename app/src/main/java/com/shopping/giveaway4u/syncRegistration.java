...
public class syncRegistration extends AsyncTask<String,String,String>
{
    ...
    public syncRegistration(Context cxt, String method, String apiurl, String param, jsonObjects info)
    {
        this.context = cxt;
        this.method = method;
        this.param = param;
