...
public class syncShipping_address extends AsyncTask<String,String,String>
{
    ...
    String API_URL = hosts.shippingAddress;


    public syncShipping_address(Context cxt, info info)
    {
