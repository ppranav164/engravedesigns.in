...
public class syncSavePaymentMethod extends AsyncTask<String,String,String>
{
    ...
    String API_URL = hosts.setPayment;


    public syncSavePaymentMethod(Context cxt, String param, info info)
    {
