...
public class syncSaveShippingMethod extends AsyncTask<String,String,String>
{
    ...
    String API_URL = hosts.shippingSave;


    public syncSaveShippingMethod(Context cxt, String param, info info)
    {
